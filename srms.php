...
<body>
    ...
    <?php
        ...
        while ($student = $result->fetch_object()){
            ...
            echo '<td align="center">'.'<a href="edit.php?id='.$student -> stud_id.' "class="btn btn-secondary" " style="margin-left: 5px;">EDIT</a>'.
            '<a href="delete.php?id='.$student -> stud_id.'"class="btn btn-danger" onclick="return confirm(\'Are you sure you want to delete this data?\')" style="margin-left: 5px;">DELETE</a>'.'</td>';
            echo '</tr>';
            $cnt ++;
        }
            echo '<tr>
